...
public class MailUtil {
	...
	public static void sendEmail(String resultHtml) throws Exception {
...
//
//		// 消息
//		messageBodyPart.setText(resultHtml);
...
//
//		DataSource source = new FileDataSource("D:\\Java\\freemarker\\result" + newdate + ".html");
//		messageBodyPart.setDataHandler(new DataHandler(source));
//
//		// messageBodyPart.setFileName(filename);
//		// 处理附件名称中文（附带文件路径）乱码问题
//		messageBodyPart.setFileName(MimeUtility.encodeText("D:\\Java\\freemarker\\result" + newdate + ".html"));
//		multipart.addBodyPart(messageBodyPart);
//
//		// 发送完整消息
...
//
//		MailUtil.sendEmail();
//		System.out.println("niadchfuwhfl");
//	}
